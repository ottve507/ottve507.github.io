...
const SHEET_API_URL  = 'https://script.google.com/macros/s/AKfycbzZFLSHIFK4Ejrp6jah6zzzWGPPzAgKGWgxgUPAdQJ6bkgNKwPFEFb92_FEs0m-vI6l/exec';  // e.g. https://script.google.com/macros/s/.../exec
...
async function saveUserData() {
  ...
  try {
    ...
    document.getElementById('app').innerHTML = '<p>Error saving data.</p>';
  }
}
...
async function deleteUserData() {
  try {
    ...
    document.getElementById('app').innerHTML = '<p>Error deleting data.</p>';
  }
}
